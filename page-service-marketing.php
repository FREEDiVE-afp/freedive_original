...
Template Name: サービス紹介｜マーケティング設計
*/
			...
			<div class="inner1000">
				<div class="fv-conts">
					<div class="fv-text">
						...
						<a href="https://freedive.co.jp/contact/business-contact.html" class="fv-btn">お問い合わせ<span class="arrow-double"></span></a>
					</div>
					<figure class="fv-img">
						<?php echo get_the_post_thumbnail( get_the_ID(), 'thumbnail', array( 'class' => 'prof-thumb' ) ); ?>
					</figure>
				</div>
				<div class="fv-banner">
					<a href="<?php echo get_permalink( 670 );?>">
						<img src="<?php echo get_template_directory_uri(); ?>/assets/img/service/manga-banner.png" alt="FREEDiVEが5分でわかる!!　マンガページはこちら" class="pc-only">
						<img src="<?php echo get_template_directory_uri(); ?>/assets/img/service/manga-banner-small.png" alt="FREEDiVEが5分でわかる!!　マンガページはこちら" class="sp-only">
					</a>
				</div>
			</div><!--inner end-->
		</section><!--fv end-->
