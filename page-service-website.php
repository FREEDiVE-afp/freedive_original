...
get_header(); ?>
		...
		<section class="fv parallax-window toggle-bg" data-parallax="scroll" data-image-src="<?php echo get_template_directory_uri(); ?>/assets/img/bg_sea_pc.jpg">
			<div class="inner1000">
				<div class="fv-conts">
					<figure class="fv-img">
						<img src="/wp-content/themes/freedive_original/assets/img/service/website/icon_website.svg" alt="WEBサイト制作">
						<div class="code-editor">
						<span class="control"></span>
						<span class="control"></span>
						<span class="control"></span>
						<p class="code">&lt;!DOCTYPE html&gt;</p>
						<p class="code">*<span class="pc-only-inline">,*::before,*::after</span>{box-sizing:border-box;}</p>
						<p class="code">function (){var xx = 0;}</p>
