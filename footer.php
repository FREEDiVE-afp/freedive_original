			...
			<li class="footer-nav_menu" itemprop="hasPart" itemscope itemtype="http://schema.org/WebPage">
				<div><span itemprop="name"><a href="<?php echo get_permalink( 80 );?>" itemprop="url">特徴</a></span>
					...
					<dl>
						...
						<dd itemprop="name"><a href="<?php echo get_permalink( 128 );?>" itemprop="url">マーケティング設計</a></dd>
						<dd itemprop="name"><a href="<?php echo get_permalink( 649 );?>" itemprop="url">採用コンサルティング</a></dd>
					</dl>
				</li>
