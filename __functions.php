...
function my_freedive_style() {
    ...
    if (is_page( 'service-ad' )|| is_page( 'service-website' )|| is_page( 'service-marketing' )|| is_page( 'service-recruiting' )|| is_page( 'service-marketing-manga' ) ) {
    ...
    if (is_page( 'blog' )||in_category('business-blog')||is_page('ppage')|| is_search()|| in_category('executive-message')||is_page( 'executive-message' )) {
...
function my_class_names($classes) {
    ...
    elseif(is_page( 'blog' )|| is_page('ppage')|| is_search()||is_page( 'business-blog' )){
    	$classes[] = 'wrap b-blog blog';
    }
	 elseif( is_page( 'case-study' )||in_category('case-study')){
    	$classes[] = 'wrap c-study';
    }
	elseif ( in_category('business-blog')){
...
//   if(is_search()) {
//     $search .= " AND (post_type = 'past' OR post_type='page' OR post_type='blog')";
//   }
//   return $search;
// }
