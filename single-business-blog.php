<?php
/*
Template Name: ビジネス記事ブログ
Template Post Type: post,business-blog
*/
 ...
 ?>
		...
		<div class="breadcrumbs">
			<ul itemscope itemtype="http://schema.org/BreadcrumbList">
				...
				<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="/blog"><span itemprop="name">ビジネスブログ</span></a><meta itemprop="position" content="2" /></li>
    ...
    "image": {
        ...
        "height":" 214"
					...
					<ul class="share-btns">
						...
						<?php echo  twitter('@YabaAD_coo',get_the_permalink(),get_the_title()); ?>
					</ul>
